...
export async function getAnioJsDependencies(
	...
	if (ts.isExportSpecifier(node)) {
		...
		// NB: synthetic files are a special type of autogenerated file
		else if (unresolved_path.startsWith("#~synthetic/")) {
			resolved_path = path.join(
				project_root, "auto", "synthetic", "src", unresolved_path.slice(12)
			)
		} else {
			throw new Error(
